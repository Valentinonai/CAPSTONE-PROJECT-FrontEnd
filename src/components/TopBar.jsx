  ...
  return (
    <Navbar expand="lg" id="topBar" className="px-2">
      ...
      <div className="d-flex justify-content-center align-items-center" id="topbarUserSection">
        <NavDropdown title={user ? user.nome : "User"} drop="down" align="end" id="basic-nav-dropdown" className="me-2">
          {user && (
            <NavDropdown.Item>
      ...
      <Navbar.Collapse id="basic-navbar-nav">
        <Nav className="me-auto">
          ...
          <Link
            to={"/store"}
            className={
              loc.pathname === "/store" ? "topbarSelected ms-3 mb-2 mb-lg-0 mt-4 mt-lg-0" : "ms-3 mb-2 mb-lg-0 mt-lg-0"
            }
          >
            Store
          </Link>
          <Link
            to={"/build"}
            className={
              loc.pathname === "/build" ? "topbarSelected ms-3 mb-2 mb-lg-0 mt-4 mt-lg-0" : "ms-3 mb-2 mb-lg-0 mt-lg-0"
            }
          >
            Build
          </Link>
